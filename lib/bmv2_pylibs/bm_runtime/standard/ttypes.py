...
class InvalidSwapOperation(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidSwapOperation, self).__setattr__('code', code)
...
class InvalidParseVSetOperation(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidParseVSetOperation, self).__setattr__('code', code)
...
class InvalidDevMgrOperation(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidDevMgrOperation, self).__setattr__('code', code)
...
class InvalidCrcOperation(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidCrcOperation, self).__setattr__('code', code)
...
class InvalidToeplitzHashOperation(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidToeplitzHashOperation, self).__setattr__('code', code)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.notifications_socket = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.elogger_socket = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.debugger_socket = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class InvalidIdLookup(TException):
    ...
    def __init__(self, code=None,):
        super(InvalidIdLookup, self).__setattr__('code', code)
