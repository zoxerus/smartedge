...
class Client(Iface):
    ...
    def mc_complete_operations(self, sess_hdl):
        ...
        return self.recv_mc_complete_operations()
    ...
    def recv_mc_complete_operations(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "mc_complete_operations failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_mc_complete_operations(self, seqid, iprot, oprot):
        ...
        result = mc_complete_operations_result()
        try:
            result.success = self._handler.mc_complete_operations(args.sess_hdl)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
