...
class Iface(object):
    ...
    def set_egress_priority_queue_depth(self, port_num, priority, depth_pkts):
        """
        Parameters:
         - port_num
         - priority
    ...
    def set_egress_priority_queue_rate(self, port_num, priority, rate_pps):
        """
        Parameters:
         - port_num
         - priority
...
class Client(Iface):
    ...
    def set_egress_priority_queue_depth(self, port_num, priority, depth_pkts):
        ...
        """
        self.send_set_egress_priority_queue_depth(port_num, priority, depth_pkts)
        return self.recv_set_egress_priority_queue_depth()

    def send_set_egress_priority_queue_depth(self, port_num, priority, depth_pkts):
        self._oprot.writeMessageBegin('set_egress_priority_queue_depth', TMessageType.CALL, self._seqid)
        args = set_egress_priority_queue_depth_args()
    ...
    def recv_set_egress_priority_queue_depth(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = set_egress_priority_queue_depth_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "set_egress_priority_queue_depth failed: unknown result")
    ...
    def set_egress_priority_queue_rate(self, port_num, priority, rate_pps):
        ...
        """
        self.send_set_egress_priority_queue_rate(port_num, priority, rate_pps)
        return self.recv_set_egress_priority_queue_rate()

    def send_set_egress_priority_queue_rate(self, port_num, priority, rate_pps):
        self._oprot.writeMessageBegin('set_egress_priority_queue_rate', TMessageType.CALL, self._seqid)
        args = set_egress_priority_queue_rate_args()
        args.port_num = port_num
        args.priority = priority
    ...
    def recv_set_egress_priority_queue_rate(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = set_egress_priority_queue_rate_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "set_egress_priority_queue_rate failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["set_egress_priority_queue_depth"] = Processor.process_set_egress_priority_queue_depth
        ...
        self._processMap["set_egress_priority_queue_rate"] = Processor.process_set_egress_priority_queue_rate
    ...
    def process_set_egress_priority_queue_depth(self, seqid, iprot, oprot):
        args = set_egress_priority_queue_depth_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = set_egress_priority_queue_depth_result()
        try:
            result.success = self._handler.set_egress_priority_queue_depth(args.port_num, args.priority, args.depth_pkts)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("set_egress_priority_queue_depth", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_set_egress_priority_queue_rate(self, seqid, iprot, oprot):
        args = set_egress_priority_queue_rate_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = set_egress_priority_queue_rate_result()
        try:
            result.success = self._handler.set_egress_priority_queue_rate(args.port_num, args.priority, args.rate_pps)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("set_egress_priority_queue_rate", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class mirroring_session_add_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.ouch = InvalidMirroringOperation.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class set_egress_priority_queue_depth_args(object):
    """
    Attributes:
     - port_num
     - priority
    ...
    def __init__(self, port_num=None, priority=None, depth_pkts=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('set_egress_priority_queue_depth_args')
        ...
        if self.depth_pkts is not None:
            oprot.writeFieldBegin('depth_pkts', TType.I32, 3)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(set_egress_priority_queue_depth_args)
set_egress_priority_queue_depth_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'port_num', None, None, ),  # 1
    (2, TType.I32, 'priority', None, None, ),  # 2
    (3, TType.I32, 'depth_pkts', None, None, ),  # 3
)


class set_egress_priority_queue_depth_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('set_egress_priority_queue_depth_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(set_egress_priority_queue_depth_result)
set_egress_priority_queue_depth_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
...
class set_egress_priority_queue_rate_args(object):
    """
    Attributes:
     - port_num
     - priority
    ...
    def __init__(self, port_num=None, priority=None, rate_pps=None,):
        self.port_num = port_num
        self.priority = priority
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('set_egress_priority_queue_rate_args')
        if self.port_num is not None:
            oprot.writeFieldBegin('port_num', TType.I32, 1)
            oprot.writeI32(self.port_num)
            oprot.writeFieldEnd()
        ...
        if self.rate_pps is not None:
            oprot.writeFieldBegin('rate_pps', TType.I64, 3)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(set_egress_priority_queue_rate_args)
set_egress_priority_queue_rate_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'port_num', None, None, ),  # 1
    (2, TType.I32, 'priority', None, None, ),  # 2
    (3, TType.I64, 'rate_pps', None, None, ),  # 3
)


class set_egress_priority_queue_rate_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('set_egress_priority_queue_rate_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(set_egress_priority_queue_rate_result)
set_egress_priority_queue_rate_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
